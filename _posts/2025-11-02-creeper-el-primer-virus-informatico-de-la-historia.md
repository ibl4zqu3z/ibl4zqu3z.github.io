...
title: "Creeper: el primer virus informático de la historia"
excerpt: "Caso de estudio sobre creeper y sus implicaciones técnicas, defensivas y organizativas."

permalink: "/blog/casos-de-estudio/creeper-el-primer-virus-informatico-de-la-historia/"
slug: "creeper-el-primer-virus-informatico-de-la-historia"
cover_image: assets/img/blog/Creeper/cover.webp
...
kicker_secondary: "Creeper"
tags:
  - "casos historicos"


post_title: "Creeper: el primer virus informático de la historia"
description: "Análisis del caso Creeper: el primer virus informático de la historia, con contexto, impacto y lecciones defensivas aplicables a ciberseguridad."
...
toc_html: |
  <a href="#nacimiento-de-creeper">Nacimiento de Creeper</a>
  <a href="#era-realmente-un-virus">Era realmente un virus</a>
  <a href="#reaper">Reaper</a>
  <a href="#relacion-con-pentesting">Relación con pentesting</a>
...
## Nacimiento de Creeper {#nacimiento-de-creeper}
...
{% capture code %}I'M THE CREEPER. CATCH ME IF YOU CAN!{% endcapture %}
{% include code-window.html
  title="Mensaje Creeper"
  code=code %}


## Era realmente un virus {#era-realmente-un-virus}
...
## Relación con pentesting {#relacion-con-pentesting}
